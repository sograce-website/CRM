...
def home(request: Request, q: str = ""):
    ...
    return f"""
<html><head><title>SOGRACE CRM V4.4 Professional Dashboard</title>
<style>
...
<div class="header">SOGRACE CRM V4.4 Professional Dashboard <a style="float:right;font-size:16px" href="/logout">Logout</a></div>
<div class="container">
<div class="card">
<h2>🚀 CRM V4.4 Dashboard</h2>
<div style="display:grid;grid-template-columns:repeat(4,1fr);gap:12px">
<div class="stat">AUTO COLLECT<br>READY</div>
<div class="stat">AUTO SEND<br>READY</div>
<div class="stat">REPLY CENTER<br>ENABLED</div>
<div class="stat">PIPELINE<br>ACTIVE</div>
</div>
<p style="margin-top:15px">
<a class="export" href="/email_center">Email Center</a>
<a class="export" href="/reply_center">Reply Center</a>
<a class="export" href="/auto_collect">Auto Collect</a>
</p>
</div>
...
def reply_center():
    ...
    <p>Reply Center installed successfully.</p>
    <a href="/">Back CRM</a>
    </body></html>
    """)
