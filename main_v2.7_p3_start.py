...
def home(request: Request, q: str = ""):
    ...
    return f"""
<html><head><title>SOGRACE CRM V2.7 Professional P2 Timeline</title>
<style>
...
<div class="header">SOGRACE CRM V2.7 Professional P2 Timeline <a style="float:right;font-size:16px" href="/logout">Logout</a></div>
<div class="container">
