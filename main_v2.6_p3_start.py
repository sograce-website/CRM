...
def home(request: Request, q: str = ""):
    ...
    return f"""
<html><head><title>SOGRACE CRM V2.6 Professional P2</title>
<style>
...
<div class="header">SOGRACE CRM V2.6 Professional P2 <a style="float:right;font-size:16px" href="/logout">Logout</a></div>
<div class="container">
