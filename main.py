...
def _v51_collect_numbers():
    ...
    if "ERROR" in text[-1000:] or "Traceback" in text[-1000:]:
        status = "Check Log"
    return {"status": status, "found": found, "today": _v51_today_count_from_text(text), "message": "Collector log loaded"}
...
<div class="layout">
  ...
  <main class="main">
    ...
    <div class="grid">
      ...
      <div class="card"><div class="label">Auto Collect</div><div class="num">{v51_collect_status}</div><div class="small">Found: {v51_collect_found} · Today: {v51_collect_today}</div></div>
