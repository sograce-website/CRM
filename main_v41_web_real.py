...
<a class="export" href="/bulk_test_5">Bulk Email Test 5</a>
<a class="export" href="/bulk_send/10">Send 10</a>
...
<a class="export" href="/auto_send/5">Auto Send 5</a>
<a class="export" href="/auto_send/20">Auto Send 20</a>
...
def auto_send_web(request: Request, background_tasks: BackgroundTasks, count: int = ApiPath(..., ge=1, le=50)):
    if not is_login(request):
        return RedirectResponse("/login", 303)
