...
from fastapi import BackgroundTasks, Path, FastAPI, Form, UploadFile, File, Request
import re
import subprocess
...
def home(request: Request, q: str = ""):
    ...
    return f"""
<html><head><title>SOGRACE CRM V2.8 Professional P1 Email Center</title>
<style>
...
<div class="header">SOGRACE CRM V2.8 Professional P1 Email Center <a style="float:right;font-size:16px" href="/logout">Logout</a></div>
<div class="container">
...
<button>Search</button><a class="export" href="/">Reset</a><a class="export" href="/export">Export CSV</a><a class="export" href="/bulk_test_5">Bulk Email Test 5</a><a class="export" href="/bulk_send/10">Send 10</a><a class="export" href="/bulk_send/50">Send 50</a><a class="export" href="/bulk_send/100">Send 100</a><a class="export" href="/auto_collect">Auto Collect Leads</a><a class="export" href="/lead_collect_log">Collector Log</a></form>
...
def bulk_send(request: Request, background_tasks: BackgroundTasks, count: int = Path(..., ge=1, le=100)):
    if not is_login(request):
...
def lead_collect_log(request: Request):
    ...
    try:
        log_path = Path("/home/admin/crm/lead_collector.log")
        ...
        <p><a href="/auto_collect">Start Auto Collect</a> | <a href="/">Back to CRM</a></p>
        <pre style="white-space:pre-wrap;background:#111;color:#0f0;padding:20px;border-radius:10px;">{text}</pre>
        """)
    except Exception as e:
        return HTMLResponse(f"<h2>Log Error</h2><pre>{str(e)}</pre><p><a href='/'>Back</a></p>")
...
def download_auto_leads(request: Request):
    ...
    file_path = Path("/home/admin/crm/auto_leads.csv")
